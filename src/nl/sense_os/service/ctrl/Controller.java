...
/**
* A singleton that includes all the intelligent methods of the sense-android-library that define the function
...
public class Controller
{
	...
	* noticeable difference compared to the previous one or not, respectively
	*
	* @param value
