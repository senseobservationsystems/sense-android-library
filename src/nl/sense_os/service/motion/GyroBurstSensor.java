...
public class GyroBurstSensor implements MotionSensorInterface {

    private static final String TAG = "GyroBurstSensor";
    ...
    private boolean sampleComplete = true;

    public GyroBurstSensor(Context context) {
    ...
    private void sendData(Sensor sensor) {
        ...
        i.putExtra(DataPoint.SENSOR_NAME, SensorNames.GYRO_BURST);
