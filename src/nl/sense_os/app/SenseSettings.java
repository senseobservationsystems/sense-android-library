...
public class SenseSettings extends PreferenceActivity {
    ...
    public static final String URL_CHECK_PHONE = URL_BASE + "sp_check.php";
    ...
    public static final String URL_REG_PHONE = URL_BASE + "sp_add.php";
    public static final String URL_SEND_SENSOR_DATA = URL_BASE + "sp_sensor_add.php";
    public static final String URL_SEND_SENSOR_DATA_FILE = URL_BASE + "sp_sensor_add_file.php";
