...
/**
 * Contains all preference keys for the SharedPreferences that are used by the
 * Sense library.<br/>
 * <br/>
 * Nota bene: there are three separate preference files:
 * <ul>
 * <li>{@link #MAIN_PREFS}, containing the settings for the sensors and sample
 * and sync rates;</li>
 * <li>{@link #AUTH_PREFS}, containing all user-related stuff like login,
 * session, cached sensor IDs;</li>
 * <li>{@link #STATUS_PREFS}, containing settings about which sensors are
 * activated.</li>
 * </ul>
 * 
 * To access the settings, you should not uses the default SharedPreference, but
 * use the names of the right preference file instead:
 * 
 * <pre>
 * // preferences about sensor settings are store in the main prefs
 * SharedPreferences mainPrefs = getSharedPreferences(SensePrefs.MAIN_PREFS,
 * 		MODE_PRIVATE);
...
public class SensePrefs {
	...
	public static class Auth {
		...
		/**
		 * Key for storing the online sensor list for this device (type of
		 * JSONArray).
		 * 
		...
		/**
		 * Key for storing the online sensor list for this user (type of
		 * JSONArray).
		 * 
		 * @see #SENSOR_LIST
		 * @see SensePrefs#AUTH_PREFS
	...
	public static class Main {
		...
		public static class Advanced {
			...
			/**
			 * Key for preference that toggles use of compression for
			...
			/**
			 * Key for preference that enables local storage, making the sensor
			 * data available to other apps through a ContentProvider. Default
			 * is true.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			...
			/**
			 * Key for preference that enables communication with CommonSense.
			 * Disable this to work in local-only mode. Default is true.
			 */
			public static final String USE_COMMONSENSE = "use_commonsense";
			/**
			 * Key for preference that enables the location feedback sensor.
			 * Enable this to participate in Pim's location feedback test.
			 * Default is false.
			 */
		...
		public static class Ambience {
			/**
			 * Key for preference that toggles use of light sensor in ambience
			 * sensing.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of camera light sensor in
			 * ambience sensing.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of the microphone in ambience
			 * sensing.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of the audio spectrum in
			 * ambience sensing.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of the pressure sensor in
			 * ambience sensing.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of the temperature sensor in
			 * ambience sensing.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of the magnetic field sensor
			 * in ambience sensing.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of the relative humidity
			 * sensor in ambience sensing.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
		...
		public static class DevProx {
			/**
			 * Key for preference that toggles use of Bluetooth in the Device
			 * Proximity sensor.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of Wi-Fi in the Device
			 * Proximity sensor.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of NFC in the Device
			 * Proximity sensor.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
		...
		public static class External {
			...
			public static class MyGlucoHealth {
				/**
				 * Key for preference that toggles use of the MyGlucohealth
				 * sensor.
				 * 
				 * @see SensePrefs#MAIN_PREFS
				 */
			...
			public static class TanitaScale {
				/**
				 * Key for preference that toggles use of the Tanita scale
				 * sensor.
				 * 
				 * @see SensePrefs#MAIN_PREFS
				 */
			...
			public static class ZephyrHxM {
				...
				/**
				 * Key for preference that toggles use of the Zephyr HxM heart
				 * rate.
				 * 
				 * @see SensePrefs#MAIN_PREFS
				 */
		...
		public static class Location {
			...
			/**
			 * Key for preference that toggles use of Network in location
			 * sensor.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles use of sensor fusion to toggle th
			 * GPS usage.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
		...
		public static class Motion {
			/**
			 * Key for preference that toggles use of Bluetooth in the
			 * DeviceProximity sensor.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles "epi-mode", drastically changing
			 * motion sensing
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles "burst-mode", drastically
			 * changing motion sensing
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			public static final String BURSTMODE = "burstmode";
			/**
			 * Key for preference that determines whether to unregister the
			 * motion sensor between samples. Nota bene: unregistering the
			 * sensor breaks the screen rotation on some phones (e.g. Nexus S).
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */

			/**
			 * Key for preference that toggles whether to upload and store burst
			 * samples.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles motion energy sensing, which
			 * measures average kinetic energy over a sample period.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			public static final String MOTION_ENERGY = "motion_energy";
			/**
			 * Key for preference that enables fix that re-registers the motion
			 * sensor when the screen turns off.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
			...
			/**
			 * Key for preference that toggles the use of the linear
			 * acceleration sensor
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
		...
		public static class Quiz {
			...
			/**
			 * Key for generic preference that starts an update of the quiz
			...
			/**
			 * Key for preference that holds the last update time of the quiz
			 * questions with CommonSense.
			 * 
			 * @see SensePrefs#MAIN_PREFS
			 */
		...
		/**
		 * Key for preference that stores a timestamp for last time the sensors
	...
	public static class Status {
		/**
		 * Key for the main status of the sensors. Set to <code>false</code> to
		 * disable all the sensing components.
		 * 
		 * @see SensePrefs#STATUS_PREFS
		 */
		public static final String MAIN = "main service status";
		/**
		 * Key for the status of the "ambience" sensors. Set to
		 * <code>true</code> to enable sensing.
		 * 
		 * @see SensePrefs#STATUS_PREFS
		 */
		public static final String AMBIENCE = "ambience component status";
		/**
		 * Key for the status of the "device proximity" sensors. Set to
		 * <code>true</code> to enable sensing.
		 * 
		 * @see SensePrefs#STATUS_PREFS
		 */
		...
		/**
		 * Key for the status of the external Bluetooth sensors. Set to
		 * <code>true</code> to enable sensing.
		 * 
		 * @see SensePrefs#STATUS_PREFS
		 */
		...
		/**
		 * Key for the status of the location sensors. Set to <code>true</code>
		 * to enable sensing.
		 * 
		 * @see SensePrefs#STATUS_PREFS
		 */
		...
		/**
		 * Key for the status of the motion sensors. Set to <code>true</code> to
		 * enable sensing.
		 * 
		 * @see SensePrefs#STATUS_PREFS
		 */
		...
		/**
		 * Key for the status of the "phone state" sensors. Set to
		 * <code>true</code> to enable sensing.
		 * 
		 * @see SensePrefs#STATUS_PREFS
		 */
		...
		/**
		 * Key for the status of the questionnaire. Set to <code>true</code> to
		 * enable it.
		 * 
		 * @see SensePrefs#STATUS_PREFS
	...
	/**
	 * Name of the shared preferences file used for storing CommonSense
	 * authentication data. Use {@link Context#MODE_PRIVATE}.
	 * 
	...
	/**
	 * Name of the main preference file, used for storing the settings for the
	 * Sense service.
	 * 
	 * @see #AUTH_PREFS
	 * @see #STATUS_PREFS
	...
	/**
	 * Name of shared preferences file holding the desired status of the Sense
	 * service.
	 * 
	 * @see #AUTH_PREFS
	 * @see #MAIN_PREFS
	...
	/**
	 * Name of the sensor specifics file, used for storing the settings for the
	 * Sense service.
	 * 
	 * @see #AUTH_PREFS
	 * @see #STATUS_PREFS
