...
public class SubscriptionManager {
	...
	/**
	 * All DataConsumers, mapped by the name of the producer they are subscribed
	 * to.
	 */
	 ...
	 * @return A List of data producers that are registered under the given
	 *         sensor name
	 */
	 ...
	 * @return A List of data consumers that are subscribed to the given sensor
	 *         name
	 */
	 ...
	 * @return <code>true</code> if this consumer is already subscribed for
	 *         producers with this name
	 */
	 ...
	 * @param name
	 *            The name of the DataProducer
	 * @return true if any data producer is already registered under this sensor
	 *         name
	 */
	 ...
	 * @return true if the data producer is already registered under this sensor
	 *         name
	 */
	 ...
	 * </p>
	 * <p>
	 * When a data producer is registered, data consumers can subscribe to its
	 * sensor data. Registering a data producer with an existing name will add
	 * the new data producer only if this data producer is a different instance
	 * from the other data producer.
	 * </p>
	 * 
	 * @param name
	 ...
	 * </p>
	 * <p>
	 * This method subscribes a DataProcessor to receive SensorDataPoints from a
	 * DataProducer. If the DataProducer with name to subscribe to is not
	 * registered yet then the data processor will be put in the queue and will
	 * be subscribed to the DataProducer when it is registered.
	 * </p>
	 * 
	 * @param name
	 ...
	 * @return true if the DataConsumer successfully subscribed to the
	 *         DataProducer.
	 */
	public synchronized boolean subscribeConsumer(String name,
	 ...
	 * <br/>
	 * No new data consumers can subscribe to the DataProducer anymore, but
	 * DataConsumer which have already subscribed to the DataProducer will
	 * remain subscribed.
	 * 
	 * @param name
	 ...
	 */
	public synchronized void unregisterProducer(String name,
		...
		// remove the producer from the list of registered producers for this
		// sensor name
	 ...
	 *            The DataConsumer that receives the sensor data
	 */
	public synchronized void unsubscribeConsumer(String name,
			DataConsumer consumer) {
