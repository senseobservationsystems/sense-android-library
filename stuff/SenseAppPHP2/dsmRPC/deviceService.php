...
?>
<html>
<head><title>Device Service Panel</title></head>
<body>
...
print "<table width=100%><tr><td>You are here: <a href=\"login.php\">Home</a>-<a href=\"deviceService.php?ds_id=$ds_id&ds_type=$ds_type\">DeviceService</a></td><td>hi $userName - <a href=\"login.php?logout=1\">logout</td></tr></table><br><br>";
		...
		//displayMethod($methodName);
	      //{
			...
			else
			{
			  ...
			  print "<form action=\"deviceService.php\" method=\"POST\">
...
print "</td><td><iframe width=100% height=100% src=\"../deviceservices/$ds_type.php?viewService=1&ds_type=$ds_type&ds_id=$ds_id\"></iframe></td></tr></table>";
?>
</body>
</html>
